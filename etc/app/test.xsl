<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"><!-- generated by module html-template-engine --><xsl:output method="html"></xsl:output><xsl:variable name="eudat.instance.devel">eudat.ui.devel.argo.grnet.gr</xsl:variable><xsl:variable name="eudat.instance.prod">eudat.ui.argo.grnet.gr</xsl:variable><xsl:variable name="app.version">2.1.7</xsl:variable><xsl:variable name="sdc.instance.devel">sdc.ui.devel.argo.grnet.gr</xsl:variable><xsl:variable name="egi.instance.prod">egi.ui.argo.grnet.gr</xsl:variable><xsl:variable name="sdc.instance.prod">sdc.ui.argo.grnet.gr</xsl:variable><xsl:variable name="egi.instance.devel">egi.ui.devel.argo.grnet.gr</xsl:variable><xsl:variable name="app.instance">prod</xsl:variable><xsl:template match="/"><html lang="en" xmlns:tpl="http://software.in2p3.fr/lavoisier/template.xsd">
    <head>
                ...
                <div class="sidebar">
                    ...
                    <nav class="mt-2">
                        <ul class="nav nav-pills nav-sidebar flex-column" data-accordion="false" data-widget="treeview" role="menu">
                            ...
                            <li class="nav-item">
                                <xsl:choose><xsl:when test="{$app.instance}!=&apos;prod&apos;"><a class="nav-link" href="http://{$egi.instance.devel}">
                                    <i class="nav-icon far fa-circle text-blue"></i>
                                    <p>EGI ARGO</p>
                                </a></xsl:when><xsl:otherwise><a class="nav-link" href="http://{$egi.instance.prod}">
                                    <i class="nav-icon far fa-circle text-blue"></i>
                                    <p>EGI ARGO</p>
                            ...
                            <li class="nav-item">
                                <xsl:choose><xsl:when test="{$app.instance}!=&apos;prod&apos;"><a class="nav-link" href="http://{$eudat.instance.devel}">
                                    <i class="nav-icon far fa-circle text-warning"></i>
                                    <p>EUDAT ARGO</p>
                                </a></xsl:when><xsl:otherwise><a class="nav-link" href="http://{$eudat.instance.prod}">
                                    <i class="nav-icon far fa-circle text-warning"></i>
                                    <p>EUDAT ARGO</p>
                                </a></xsl:otherwise></xsl:choose>
                            ...
                            <li class="nav-item">
                                <xsl:choose><xsl:when test="{$app.instance}!=&apos;prod&apos;"><a class="nav-link" href="http://{$sdc.instance.devel}">
                                    <i class="nav-icon far fa-circle text-success"></i>
                                    <p>SDC ARGO</p>
                                </a></xsl:when><xsl:otherwise><a class="nav-link" href="http://{$sdc.instance.prod}">
                                    <i class="nav-icon far fa-circle text-success"></i>
                                    <p>SDC ARGO</p>
                                </a></xsl:otherwise></xsl:choose>
